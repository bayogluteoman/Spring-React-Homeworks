...
public class JGPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JGPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JGPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JGPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JGPDateTimeConverter dateTimeConverter = new JGPStandardDateTimeConverter();

    public JGPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JGPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JGPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JGPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JGPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JGPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
