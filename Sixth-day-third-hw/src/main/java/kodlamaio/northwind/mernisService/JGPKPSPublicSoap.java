...
public class JGPKPSPublicSoap
{
    ...
    public JGPKPSPublicSoap(){}

    public JGPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JGPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JGPExtendedSoapSerializationEnvelope envelope= new JGPExtendedSoapSerializationEnvelope(JGPExtendedSoapSerializationEnvelope.VER11);
